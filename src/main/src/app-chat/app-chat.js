define(["exports","meta"],function(_exports,meta){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.camelToDashCase=camelToDashCase;_exports.cssFromModule=cssFromModule;_exports.cssFromModuleImports=cssFromModuleImports;_exports.cssFromModules=cssFromModules;_exports.cssFromTemplate=cssFromTemplate;_exports.dashToCamelCase=dashToCamelCase;_exports.dumpRegistrations=dumpRegistrations;_exports.get=get;_exports.incrementInstanceCount=incrementInstanceCount;_exports.isAncestor=isAncestor;_exports.isDescendant=isDescendant;_exports.isPath=isPath;_exports.matches=matches;_exports.normalize=normalize;_exports.pathFromUrl=pathFromUrl;_exports.register=register;_exports.resolveCss=resolveCss;_exports.resolveUrl=resolveUrl;_exports.root=root;_exports.set=set;_exports.split=split;_exports.stylesFromModule=stylesFromModule;_exports.stylesFromModuleImports=stylesFromModuleImports;_exports.stylesFromModules=stylesFromModules;_exports.stylesFromTemplate=stylesFromTemplate;_exports.translate=translate;_exports.wrap=_exports.version$1=_exports.version=_exports.useShadow=_exports.useNativeCustomElements=_exports.useNativeCSSProperties=_exports.useAdoptedStyleSheetsWithBuiltCSS=_exports.updateStyles=_exports.timeOut=_exports.syncInitialRender=_exports.suppressTemplateNotifications=_exports.supportsAdoptingStyleSheets=_exports.strictTemplatePolicy=_exports.setUseAdoptedStyleSheetsWithBuiltCSS=_exports.setSyncInitialRender=_exports.setSuppressTemplateNotifications=_exports.setStrictTemplatePolicy=_exports.setSanitizeDOMValue=_exports.setRootPath=_exports.setRemoveNestedTemplates=_exports.setPassiveTouchGestures=_exports.setOrderedComputed=_exports.setLegacyWarnings=_exports.setLegacyUndefined=_exports.setLegacyOptimizations=_exports.setLegacyNoObservedAttributes=_exports.setFastDomIf=_exports.setCancelSyntheticClickEvents=_exports.setAllowTemplateFromDomModule=_exports.sanitizeDOMValue=_exports.rootPath=_exports.removeNestedTemplates=_exports.registrations=_exports.passiveTouchGestures=_exports.orderedComputed=_exports.microTask=_exports.legacyWarnings=_exports.legacyUndefined=_exports.legacyOptimizations=_exports.legacyNoObservedAttributes=_exports.isDeep=_exports.instanceCount=_exports.idlePeriod=_exports.htmlLiteral=_exports.html$1=_exports.html=_exports.getSanitizeDOMValue=_exports.fastDomIf=_exports.dedupingMixin=_exports.cancelSyntheticClickEvents=_exports.builtCSS=_exports.animationFrame=_exports.allowTemplateFromDomModule=_exports.TemplateStamp=_exports.PropertyEffects=_exports.PropertyAccessors=_exports.PropertiesMixin=_exports.PropertiesChanged=_exports.PolymerElement=_exports.ElementMixin=_exports.DomModule=_exports.$wrap=_exports.$templateStamp=_exports.$telemetry=_exports.$styleGather=_exports.$settings=_exports.$resolveUrl=_exports.$propertyEffects=_exports.$propertyAccessors=_exports.$propertiesMixin=_exports.$propertiesChanged=_exports.$polymerElement=_exports.$path=_exports.$mixin=_exports.$htmlTag=_exports.$elementMixin=_exports.$domModule=_exports.$caseMap=_exports.$async=void 0;meta=babelHelpers.interopRequireWildcard(meta);function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){keys.push.apply(keys,Object.getOwnPropertySymbols(object))}if(enumerableOnly)keys=keys.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable});return keys}function _objectSpread(target){for(var i=1,source;i<arguments.length;i++){source=null!=arguments[i]?arguments[i]:{};if(i%2){ownKeys(source,!0).forEach(function(key){babelHelpers.defineProperty(target,key,source[key])})}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source))}else{ownKeys(source).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key))})}}return target}/**
@license
...
return polymerElementBase._addTemplatePropertyEffect.call(this,templateInfo,prop,effect)}}return PolymerElement});/**
   ...
   */const html=function html(strings,...values){const template=/** @type {!HTMLTemplateElement} */document.createElement("template");template.innerHTML=values.reduce((acc,v,idx)=>acc+htmlValue(v)+strings[idx+1],strings[0]);return template};/**
    ...
    */_exports.html$1=_exports.html=html;const htmlLiteral=function(strings,...values){return new LiteralString(values.reduce((acc,v,idx)=>acc+literalValue(v)+strings[idx+1],strings[0]))};_exports.htmlLiteral=htmlLiteral;var htmlTag={html:html,htmlLiteral:htmlLiteral};_exports.$htmlTag=htmlTag;const PolymerElement=ElementMixin(HTMLElement);_exports.PolymerElement=PolymerElement;var polymerElement={version:version,PolymerElement:PolymerElement,html:html};_exports.$polymerElement=polymerElement;class AppChat extends PolymerElement{constructor(){super();this.isButtonDisabled=!0;this.buttonStyleClass="btn-disabled";this.messages=[];this.boundChatMessage=this.getChatMessage.bind(this)}static get template(){return html`
      <style>
        :host {
          width: 100%;
          height: 100%;
    ...
    `}connectedCallback(){super.connectedCallback();window.addEventListener("get-chat-message",this.boundChatMessage)}disconnectedCallback(){super.disconnectedCallback();window.removeEventListener("get-chat-message",this.boundChatMessage)}getChatMessage(e){const message=e.detail.message;this.messages.push({message,own:!1});this._updateInnerHTML()}handleSendMessage(){const message=this.$["input-message"].value;this.dispatchEvent(new CustomEvent("send-chat-message",{detail:{message},bubbles:!0,composed:!0}));this.messages.push({message,own:!0});this._updateInnerHTML()}handleInput(){this.isButtonDisabled=!this.$["input-message"].value;this.buttonStyleClass=this.isButtonDisabled?"btn-disabled":""}_updateInnerHTML(){const inner=this.messages.reduce((prev,el)=>{const elem=`
          <div class="chat-message-${el.own?"left":"right"}">
            ${el.message}
          </div>
        `;return prev+elem},"");this.$.messages.innerHTML=inner;this.$.messages.scrollTop=this.$.messages.scrollHeight}}window.customElements.define("app-chat",AppChat)});