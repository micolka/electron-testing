...
var createWindow = function () {
    var mainWindow = new electron_1.BrowserWindow({
        ...
        minWidth: 400,
        webPreferences: {
            preload: '/home/micolka/projects/electron-testing/.webpack/renderer/main_window/preload.js',
        },
    });
...
electron_1.ipcMain.on('open-additioonal-window', function () {
    var secondWindow = new electron_1.BrowserWindow({
        width: 400,
        height: 300,
        webPreferences: {
            preload: '/home/micolka/projects/electron-testing/.webpack/renderer/second_window/preload.js',
        }
    });
    secondWindow.loadURL('http://localhost:3000/second_window');
    secondWindow.webContents.openDevTools();
    var dataListener = function (_, data) {
        secondWindow.webContents.send('transfer-data-from-main', data);
    };
    electron_1.ipcMain.on('transfer-input-data', dataListener);
    secondWindow.on('close', function () {
        electron_1.ipcMain.removeListener('transfer-input-data', dataListener);
    });
});
